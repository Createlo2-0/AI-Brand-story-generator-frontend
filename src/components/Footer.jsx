...
export default function Footer() {
  return (
    <footer className="bg-black text-white pt-12 mt-[-18px] pb-4 px-4">
      ...
      {/* Main Footer */}
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-start justify-between gap-10 md:gap-0 pb-8">
        {/* Logo */}
        <div className="flex flex-col items-center mr-6 md:items-start mb-8 md:mb-0">
